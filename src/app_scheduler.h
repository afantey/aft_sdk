 ...
 *     event (typically when om_app_evt_wait() returns).
 *
 ...
 *
 * @retval      OM_SUCCESS               Successful initialization.
 * @retval      OM_ERROR_INVALID_PARAM   Invalid parameter (buffer not aligned to a 4 byte
 *                                        boundary).
 */
 ...
 *
 * @return      OM_SUCCESS on success, otherwise an error code.
 */
